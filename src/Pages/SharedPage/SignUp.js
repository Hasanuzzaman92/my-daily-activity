    ...
    <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl dark:dark:dark:bg-gray-900 dark:dark:dark:text-gray-100">
      ...
      >
        <div className="space-y-1 text-sm">
          <label htmlFor="name" className="block dark:dark:dark:text-gray-400">
            Name:
          </label>
          <input
            required
        ...
        <div className="space-y-1 text-sm">
          <label htmlFor="email" className="block dark:dark:dark:text-gray-400">
            Email:
          </label>
          <input
            required
        ...
        <div className="space-y-1 text-sm">
          <label
            htmlFor="password"
            className="block dark:dark:dark:text-gray-400"
          >
            Password:
          </label>
          <input
      ...
      <div className="flex items-center pt-4 space-x-1">
        ...
        <p className="px-3 text-sm dark:dark:dark:text-gray-400">
      ...
      <p className="text-xs text-center sm:px-6 dark:dark:dark:text-gray-400">
        Already have an account?
        <Link
          rel="noopener noreferrer"
          to="/login"
          className="underline text-sky-500 ml-2 dark:dark:dark:text-gray-100"
        >
          Log In
        </Link>
      </p>
